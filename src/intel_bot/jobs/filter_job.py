...
from src.intel_bot.filter.keyword_filter import keyword_pass, load_keyword_groups
                ...
                try:
                    ...
                    if not kw_ok:
                        ...
                        result.rejection_reasons[kw_reason or 'keyword_miss'] = (
                            result.rejection_reasons.get(kw_reason or 'keyword_miss', 0) + 1
                        )
                        continue
